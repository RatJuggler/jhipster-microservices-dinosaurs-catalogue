package com.rj.dinosaurs.catalogue.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("catalogue");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("catalogue");
        ...
        config.getMapConfigs().put("com.rj.dinosaurs.catalogue.domain.*", initializeDomainMapConfig(jHipsterProperties));
